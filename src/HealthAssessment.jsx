...
export default function HealthAssessment({ onBack, onComplete }) {
        ...
        <aside className="hidden lg:block w-64">
          <div className="rounded-xl bg-white border border-gray-200 p-6 shadow-sm">
            ...
            <p className="mt-6 text-xs text-gray-500 leading-relaxed">
              This assessment analyzes health and physiological markers to
              evaluate your current stress levels accurately.
            </p>
          </div>
        </aside>
          ...
          <div className="bg-white rounded-2xl border border-gray-200 shadow-sm">
            ...
            <div className="px-10 py-8 border-b border-gray-200">
              ...
              <p className="mt-2 text-sm text-gray-600 max-w-3xl">
                Please provide the following health and physiological
                information. These indicators help our AI system assess stress
            ...
            <div className="px-10 py-10 space-y-12">
              ...
              <section>
                ...
                <p className="text-sm text-gray-500 mb-6">
                  Basic demographic and body metrics influence stress response.
                </p>
              ...
              <section>
                ...
                <p className="text-sm text-gray-500 mb-6">
                  These values are required for advanced stress prediction.
                </p>
